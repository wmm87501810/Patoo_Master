...
public class CourseDetailCurriculumAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<CourseDetailBean.CourseAdvanceBean> classBeen;
    private BaseApplication baseApplication;

    public CourseDetailCurriculumAdapter(Context context, List<CourseDetailBean.CourseAdvanceBean> classBeen) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mViewHolder, final int arg1) {
        if (mViewHolder instanceof MViewHolder) {
            ...
            baseApplication.loadImageALLView(context, ((MViewHolder) mViewHolder).iv_course_cover, classBeen.get(arg1).getCover());
