...
import com.shishiTec.HiMaster.UI.controller.PhotoGridItem;
...
public class CommentPicAdappter extends BaseAdapter {
	private Context context;
	private Album album;
	private Map<String, Bitmap> cacheBms = new HashMap<String, Bitmap>();

	public CommentPicAdappter(Context context, Album album) {
