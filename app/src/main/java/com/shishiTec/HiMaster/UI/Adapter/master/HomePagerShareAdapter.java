...
/**
 * Created by hyu on 2016/5/29.
 */
public class HomePagerShareAdapter extends RecyclerView.Adapter<HomePagerShareAdapter.MyViewHolder> {

    private Context context;
    private List<UserHomePageBean.ShareListsBean> list;
    private Resources res;
    private OnItemClickListener listener;

    public HomePagerShareAdapter(Context context, List<UserHomePageBean.ShareListsBean> list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final UserHomePageBean.ShareListsBean bean = list.get(position);
