 ...
 */
public class SoyBuyCardAdapter extends RecyclerView.Adapter<SoyBuyCardAdapter.SoyCardViewHolder> {

    private Context context;
    private List<CardListsBean> mData;
    ...
    public SoyBuyCardAdapter(Context context, List<CardListsBean> mData) {
    ...
    public void onBindViewHolder(final SoyCardViewHolder holder, final int position) {
        CardListsBean soyCardBean = mData.get(position);
        BaseApplication.getInstance().loadImageALLView(context, holder.cardImg, soyCardBean.getPic_url());
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("使用期限:");
        stringBuilder.append(DateUtil.getYearMonthDay(Long.parseLong(soyCardBean.getValid_time())));
        holder.dateLimit.setText(stringBuilder.toString());
        holder.useIntro.setText(soyCardBean.getIntro());
        ...
        holder.cardImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("card_id", mData.get(position).getCard_id());
