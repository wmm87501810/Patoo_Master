...
public class CommentListItem extends RecyclerView.Adapter<CommentListItem.ItemViewHolder> {
    private Context context;
    private List<MasterCommentListBean.ReplyBean> bigManBean;
    public CommentListItem(Context context, List<MasterCommentListBean.ReplyBean> bigManBean) {
        super();
