 ...
 */
public class OtherAddressPopupWindow extends PopupWindow {

    private TextView cancel_address,choose_tv;
    public RecyclerView choose_other_address_recycler;
    private View mMenuView;
    private LinearLayoutManager linearLayoutManager;
    public OtherAddressPopupWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
