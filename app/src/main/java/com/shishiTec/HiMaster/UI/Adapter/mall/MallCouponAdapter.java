 ...
 */
public class MallCouponAdapter extends RecyclerView.Adapter<MallCouponAdapter.MallCouponViewHolder> {
    private Context context;
    private List<PaySureBean.ConditionBean.CouponBean> mData;
    private OnItemClickListener onItemClickListener;
    public MallCouponAdapter(Context context, List<PaySureBean.ConditionBean.CouponBean> mData) {
    ...
    public void onBindViewHolder(MallCouponViewHolder holder, final int position) {
        PaySureBean.ConditionBean.CouponBean couponBean = mData.get(position);
