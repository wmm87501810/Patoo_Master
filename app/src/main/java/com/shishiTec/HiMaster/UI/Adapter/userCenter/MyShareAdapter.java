...
public class MyShareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<MyShareBean> myShareBeen;
    private MyShareItemAdapter mAdapter;
    private BaseApplication baseApplication;

    public MyShareAdapter(Context context, List<MyShareBean> myShareBeen) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mViewHolder, final int arg1) {
        if (mViewHolder instanceof MasterViewHolder) {
            ...
            if (myShareBeen.get(arg1).getDetail() != null && myShareBeen.get(arg1).getDetail().size() > 1) {
                ...
                //创建并设置Adapter
                mAdapter = new MyShareItemAdapter(context, myShareBeen.get(arg1).getDetail());
    ...
    //添加数据
    public void addMoreItem(List<MyShareBean> newDatas) {
        myShareBeen.addAll(newDatas);
